...
function initContactForm() {
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", (e) => {
      // Não precisamos prevenir o comportamento padrão se estamos usando FormSubmit
      // e.preventDefault();
      ...
      // O FormSubmit vai lidar com o envio do formulário
      // Adicionamos apenas um timeout para mostrar o indicador de carregamento por um tempo
      setTimeout(() => {
